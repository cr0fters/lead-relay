...
public sealed class LeadRelayDbContext(DbContextOptions<LeadRelayDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OwnerAccountRecord>(entity =>
        {
            ...
            entity.Property(x => x.WidgetInstalledAtUtc).HasColumnName("WidgetInstalledAtUtc");
            entity.Property(x => x.WidgetInstalledDomain).HasColumnName("WidgetInstalledDomain").HasMaxLength(255);
